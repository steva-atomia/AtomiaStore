...
namespace Atomia.Store.PublicOrderHandlers.CartItemHandlers
{
    ...
    public abstract class BaseDomainHandler : OrderDataHandler
    {
        ...
        {
            var domainItems = orderContext.ItemData.Where(i => this.HandledCategories.Intersect(i.Categories).Count() > 0);
        ...
        {
            return (connectedItem.Categories.Contains("HostingPackage") &&
